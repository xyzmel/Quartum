                    ...
                    <div className="col-lg-6">
                        <div className="banner-content">
                            <AnimationOnScroll animateIn="fadeInUp" animateOnce={true} delay={100}>
                                <h1 className="title">Design som Fenger, Markedsføring som Treffer</h1>
                                <span className="subtitle">Fra Kreative Konsepter til Digital Eksponering: Design som Setter Tonen, Markedsføring som Sprer Budskapet, Resultater som Varer</span>
                                <Link to={process.env.PUBLIC_URL + "/kontakt"} className="axil-btn btn-fill-primary btn-large">Kom i gang</Link>
                            </AnimationOnScroll>
                        </div>
                    </div>
                    <div className="col-lg-6">

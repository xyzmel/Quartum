                    ...
                    <div className="row">
                        <div className="col-xl-5 col-lg-6">
                            <div className="contact-form-box shadow-box mb--30">
                                <h3 className="title">Få en gratis konsultasjon</h3>
                                <FormTwo />
                            </div>
                        </div>
                        <div className="col-xl-5 col-lg-6 offset-xl-1">
                            <div className="contact-info mb--100 mb_md--30 mt_md--0 mt--150">
                                ...
                                <p>Vi har åpent Man-Fre 09:00-17:00</p>
                                <h4 className="phone-number">+47 958 30 043</h4>
                            </div>
                            <div className="contact-info mb--30">
                                <h4 className="title">E-post</h4>
                                <p>Ta kontakt på e-post, vi svarer innen 24 timer!</p>
                                <h4 className="phone-number"><a href="mailto:info@example.com">post@kvartum.no</a></h4>
                            </div>
                        </div>
                    </div>
                </div>

                    ...
                    <div className="container">
                        ...
                        <AnimationOnScroll  animateIn="slideInUp" duration={1} delay={300} animateOnce={true}>
                            <div className="content">
                                <h2 className="title">Portefølje under arbeid</h2>
                                <p>Vi jobber med prosjekter som blir lagt ut her når samarbeidet er avsluttet.</p>
                                <Link to={process.env.PUBLIC_URL + "/"} className="axil-btn btn-fill-primary">Gå tilbake</Link>
                            </div>
                        </AnimationOnScroll>
                        </div>
                        <div className="col-lg-6">
